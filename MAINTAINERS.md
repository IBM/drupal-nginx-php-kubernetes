...
more IBM Code Pattern repositories.
...
Proposed changes branches. These branches contains your proposed changes.
...
review to indicate acceptance. A change requires one LGTM from those with commit access.
