...
request to indicate acceptance prior to merging. A change requires a LGTM from
one project maintainer. If the code is written by a maintainer, the change
does not require an additional LGTM.
